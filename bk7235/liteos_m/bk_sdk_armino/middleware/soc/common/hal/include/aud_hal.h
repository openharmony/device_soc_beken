...
/* REG_0x00 */
#define aud_hal_get_audio_config_value()                                   aud_ll_get_audio_config_value()
#define aud_hal_set_audio_config_value(value)                            aud_ll_set_audio_config_value(value)

/* REG_0x00:audio_config->samp_rate_ADC:ADC sample rate 0：8K  1：16K  2：44.1K  3：48K,RW,0x0[1:0]*/
...
/* REG_0x00:audio_config->dac_enable:DAC enable  1: enable  0: disable,RW,0x0[2]*/
...
/* REG_0x00:audio_config->adc_enable:ADC enable  1: enable  0: disable,RW,0x0[3]*/
...
/* REG_0x00:audio_config->dtmf_enable:DTMF enable 1: enable  0: disable,RW,0x0[4]*/
#define aud_hal_get_audio_config_dtmf_enable()                             aud_ll_get_audio_config_dtmf_enable()
#define aud_hal_set_audio_config_dtmf_enable(value)                      aud_hal_set_audio_config_dtmf_enable(value)

/* REG_0x00:audio_config->line_enable:LINE IN enable  1：enable  0:disable,RW,0x0[5]*/
...
/* REG_0x00:audio_config->samp_rate_DAC:DAC sample rate  0：8K  1：16K  2：44.1K  3：48K,RW,0x0[7:6]*/
...
/* REG_0x12 */
#define aud_hal_set_dac_fport_value(value)                               aud_ll_set_dacl_fport_value(value)
...
/* REG_0x27 */
#define aud_hal_get_flt2_coef_b0b1_value()                                 aud_hal_get_flt2_coef_b0b1_value()
#define aud_hal_set_flt2_coef_b0b1_value(value)                          aud_hal_set_flt2_coef_b0b1_value(value)
