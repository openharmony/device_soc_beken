...
typedef volatile struct {
	 ...
	 */
	uint32_t upper_val;
	/* RW:set the selected tick value; 
	...
	uint32_t counter_val;	//RO:current tick value of the counter 
	uint32_t up_val_lpo;	//RO:update upper value to lpo
	uint32_t tick_val_lpo;	//RO:update tick value to lpo
}aon_rtc_hw_t;
