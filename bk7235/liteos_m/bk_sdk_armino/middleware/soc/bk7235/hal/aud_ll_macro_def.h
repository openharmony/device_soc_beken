...
/* REG_0x00 */
#define AUD_AUDIO_CONFIG_ADDR  (AUD_LL_REG_BASE  + 0x0*4) //REG ADDR :0x47800000
...
/* REG_0x01 */
#define AUD_DTMF_CONFIG0_ADDR  (AUD_LL_REG_BASE  + 0x1*4) //REG ADDR :0x47800004
...
/* REG_0x02 */
#define AUD_DTMF_CONFIG1_ADDR  (AUD_LL_REG_BASE  + 0x2*4) //REG ADDR :0x47800008
...
/* REG_0x03 */
#define AUD_DTMF_CONFIG2_ADDR  (AUD_LL_REG_BASE  + 0x3*4) //REG ADDR :0x4780000c
...
static inline uint32_t aud_ll_get_agc_config0_agc_step(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_AGC_CONFIG0_ADDR);
    reg_value = ((reg_value >> AUD_AGC_CONFIG0_AGC_STEP_POS) & AUD_AGC_CONFIG0_AGC_STEP_MASK);
    return reg_value;
}

static inline void aud_ll_set_agc_config0_agc_step(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_AGC_CONFIG0_ADDR);
    reg_value &= ~(AUD_AGC_CONFIG0_AGC_STEP_MASK << AUD_AGC_CONFIG0_AGC_STEP_POS);
    reg_value |= ((value & AUD_AGC_CONFIG0_AGC_STEP_MASK) << AUD_AGC_CONFIG0_AGC_STEP_POS);
    REG_WRITE(AUD_AGC_CONFIG0_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_dtmf_fport_dtmf_port(void)
{
    ...
    reg_value = ((reg_value >> AUD_DTMF_FPORT_DTMF_PORT_POS)&AUD_DTMF_FPORT_DTMF_PORT_MASK);
    return reg_value;
}
...
static inline uint32_t aud_ll_get_adc_fport_adc_port(void)
{
    ...
    reg_value = ((reg_value >> AUD_ADC_FPORT_ADC_PORT_POS)&AUD_ADC_FPORT_ADC_PORT_MASK);
    return reg_value;
}

/* REG_0x12 */
#define AUD_DACL_FPORT_ADDR  (AUD_LL_REG_BASE  + 0x12*4) //REG ADDR :0x47800048
...
/*write only reg:dacl_fport:default value:0x0*/
static inline void aud_ll_set_dacl_fport_value(uint32_t value)
{
    REG_WRITE(AUD_DACL_FPORT_ADDR,value);
}
...
/* REG_0x20 */
#define AUD_FLT0_COEF_A1A2_ADDR  (AUD_LL_REG_BASE  + 0x20*4) //REG ADDR :0x47800080
...
{
    return REG_READ(AUD_FLT0_COEF_A1A2_ADDR);
}

static inline void aud_ll_set_flt0_coef_a1a2_value(uint32_t value)
{
    REG_WRITE(AUD_FLT0_COEF_A1A2_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_A1A2_ADDR);
    reg_value = ((reg_value >> AUD_FLT0_COEF_A1A2_FLT0_A1_POS) & AUD_FLT0_COEF_A1A2_FLT0_A1_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt0_coef_a1a2_flt0_a1(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_A1A2_ADDR);
    reg_value &= ~(AUD_FLT0_COEF_A1A2_FLT0_A1_MASK << AUD_FLT0_COEF_A1A2_FLT0_A1_POS);
    reg_value |= ((value & AUD_FLT0_COEF_A1A2_FLT0_A1_MASK) << AUD_FLT0_COEF_A1A2_FLT0_A1_POS);
    REG_WRITE(AUD_FLT0_COEF_A1A2_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_flt0_coef_a1a2_flt0_a2(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_A1A2_ADDR);
    reg_value = ((reg_value >> AUD_FLT0_COEF_A1A2_FLT0_A2_POS) & AUD_FLT0_COEF_A1A2_FLT0_A2_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt0_coef_a1a2_flt0_a2(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_A1A2_ADDR);
    reg_value &= ~(AUD_FLT0_COEF_A1A2_FLT0_A2_MASK << AUD_FLT0_COEF_A1A2_FLT0_A2_POS);
    reg_value |= ((value & AUD_FLT0_COEF_A1A2_FLT0_A2_MASK) << AUD_FLT0_COEF_A1A2_FLT0_A2_POS);
    REG_WRITE(AUD_FLT0_COEF_A1A2_ADDR,reg_value);
}

/* REG_0x21 */
#define AUD_FLT0_COEF_B0B1_ADDR  (AUD_LL_REG_BASE  + 0x21*4) //REG ADDR :0x47800084
...
{
    return REG_READ(AUD_FLT0_COEF_B0B1_ADDR);
}

static inline void aud_ll_set_flt0_coef_b0b1_value(uint32_t value)
{
    REG_WRITE(AUD_FLT0_COEF_B0B1_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_B0B1_ADDR);
    reg_value = ((reg_value >> AUD_FLT0_COEF_B0B1_FLT0_B0_POS) & AUD_FLT0_COEF_B0B1_FLT0_B0_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt0_coef_b0b1_flt0_b0(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_B0B1_ADDR);
    reg_value &= ~(AUD_FLT0_COEF_B0B1_FLT0_B0_MASK << AUD_FLT0_COEF_B0B1_FLT0_B0_POS);
    reg_value |= ((value & AUD_FLT0_COEF_B0B1_FLT0_B0_MASK) << AUD_FLT0_COEF_B0B1_FLT0_B0_POS);
    REG_WRITE(AUD_FLT0_COEF_B0B1_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_flt0_coef_b0b1_flt0_b1(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_B0B1_ADDR);
    reg_value = ((reg_value >> AUD_FLT0_COEF_B0B1_FLT0_B1_POS) & AUD_FLT0_COEF_B0B1_FLT0_B1_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt0_coef_b0b1_flt0_b1(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_B0B1_ADDR);
    reg_value &= ~(AUD_FLT0_COEF_B0B1_FLT0_B1_MASK << AUD_FLT0_COEF_B0B1_FLT0_B1_POS);
    reg_value |= ((value & AUD_FLT0_COEF_B0B1_FLT0_B1_MASK) << AUD_FLT0_COEF_B0B1_FLT0_B1_POS);
    REG_WRITE(AUD_FLT0_COEF_B0B1_ADDR,reg_value);
}

/* REG_0x22 */
#define AUD_FLT0_COEF_B2_ADDR  (AUD_LL_REG_BASE  + 0x22*4) //REG ADDR :0x47800088
...
{
    return REG_READ(AUD_FLT0_COEF_B2_ADDR);
}

static inline void aud_ll_set_flt0_coef_b2_value(uint32_t value)
{
    REG_WRITE(AUD_FLT0_COEF_B2_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_B2_ADDR);
    reg_value = ((reg_value >> AUD_FLT0_COEF_B2_FLT0_B2_POS) & AUD_FLT0_COEF_B2_FLT0_B2_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt0_coef_b2_flt0_b2(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT0_COEF_B2_ADDR);
    reg_value &= ~(AUD_FLT0_COEF_B2_FLT0_B2_MASK << AUD_FLT0_COEF_B2_FLT0_B2_POS);
    reg_value |= ((value & AUD_FLT0_COEF_B2_FLT0_B2_MASK) << AUD_FLT0_COEF_B2_FLT0_B2_POS);
    REG_WRITE(AUD_FLT0_COEF_B2_ADDR,reg_value);
}

/* REG_0x23 */
#define AUD_FLT1_COEF_A1A2_ADDR  (AUD_LL_REG_BASE  + 0x23*4) //REG ADDR :0x4780008c
...
{
    return REG_READ(AUD_FLT1_COEF_A1A2_ADDR);
}

static inline void aud_ll_set_flt1_coef_a1a2_value(uint32_t value)
{
    REG_WRITE(AUD_FLT1_COEF_A1A2_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_A1A2_ADDR);
    reg_value = ((reg_value >> AUD_FLT1_COEF_A1A2_FLT1_A1_POS) & AUD_FLT1_COEF_A1A2_FLT1_A1_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt1_coef_a1a2_flt1_a1(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_A1A2_ADDR);
    reg_value &= ~(AUD_FLT1_COEF_A1A2_FLT1_A1_MASK << AUD_FLT1_COEF_A1A2_FLT1_A1_POS);
    reg_value |= ((value & AUD_FLT1_COEF_A1A2_FLT1_A1_MASK) << AUD_FLT1_COEF_A1A2_FLT1_A1_POS);
    REG_WRITE(AUD_FLT1_COEF_A1A2_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_flt1_coef_a1a2_flt1_a2(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_A1A2_ADDR);
    reg_value = ((reg_value >> AUD_FLT1_COEF_A1A2_FLT1_A2_POS) & AUD_FLT1_COEF_A1A2_FLT1_A2_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt1_coef_a1a2_flt1_a2(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_A1A2_ADDR);
    reg_value &= ~(AUD_FLT1_COEF_A1A2_FLT1_A2_MASK << AUD_FLT1_COEF_A1A2_FLT1_A2_POS);
    reg_value |= ((value & AUD_FLT1_COEF_A1A2_FLT1_A2_MASK) << AUD_FLT1_COEF_A1A2_FLT1_A2_POS);
    REG_WRITE(AUD_FLT1_COEF_A1A2_ADDR,reg_value);
}

/* REG_0x24 */
#define AUD_FLT1_COEF_B0B1_ADDR  (AUD_LL_REG_BASE  + 0x24*4) //REG ADDR :0x47800090
...
{
    return REG_READ(AUD_FLT1_COEF_B0B1_ADDR);
}

static inline void aud_ll_set_flt1_coef_b0b1_value(uint32_t value)
{
    REG_WRITE(AUD_FLT1_COEF_B0B1_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_B0B1_ADDR);
    reg_value = ((reg_value >> AUD_FLT1_COEF_B0B1_FLT1_B0_POS) & AUD_FLT1_COEF_B0B1_FLT1_B0_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt1_coef_b0b1_flt1_b0(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_B0B1_ADDR);
    reg_value &= ~(AUD_FLT1_COEF_B0B1_FLT1_B0_MASK << AUD_FLT1_COEF_B0B1_FLT1_B0_POS);
    reg_value |= ((value & AUD_FLT1_COEF_B0B1_FLT1_B0_MASK) << AUD_FLT1_COEF_B0B1_FLT1_B0_POS);
    REG_WRITE(AUD_FLT1_COEF_B0B1_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_flt1_coef_b0b1_flt1_b1(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_B0B1_ADDR);
    reg_value = ((reg_value >> AUD_FLT1_COEF_B0B1_FLT1_B1_POS) & AUD_FLT1_COEF_B0B1_FLT1_B1_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt1_coef_b0b1_flt1_b1(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_B0B1_ADDR);
    reg_value &= ~(AUD_FLT1_COEF_B0B1_FLT1_B1_MASK << AUD_FLT1_COEF_B0B1_FLT1_B1_POS);
    reg_value |= ((value & AUD_FLT1_COEF_B0B1_FLT1_B1_MASK) << AUD_FLT1_COEF_B0B1_FLT1_B1_POS);
    REG_WRITE(AUD_FLT1_COEF_B0B1_ADDR,reg_value);
}

/* REG_0x25 */
#define AUD_FLT1_COEF_B2_ADDR  (AUD_LL_REG_BASE  + 0x25*4) //REG ADDR :0x47800094
...
{
    return REG_READ(AUD_FLT1_COEF_B2_ADDR);
}

static inline void aud_ll_set_flt1_coef_b2_value(uint32_t value)
{
    REG_WRITE(AUD_FLT1_COEF_B2_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_B2_ADDR);
    reg_value = ((reg_value >> AUD_FLT1_COEF_B2_FLT1_B2_POS) & AUD_FLT1_COEF_B2_FLT1_B2_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt1_coef_b2_flt1_b2(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT1_COEF_B2_ADDR);
    reg_value &= ~(AUD_FLT1_COEF_B2_FLT1_B2_MASK << AUD_FLT1_COEF_B2_FLT1_B2_POS);
    reg_value |= ((value & AUD_FLT1_COEF_B2_FLT1_B2_MASK) << AUD_FLT1_COEF_B2_FLT1_B2_POS);
    REG_WRITE(AUD_FLT1_COEF_B2_ADDR,reg_value);
}

/* REG_0x26 */
#define AUD_FLT2_COEF_A1A2_ADDR  (AUD_LL_REG_BASE  + 0x26*4) //REG ADDR :0x47800098
...
{
    return REG_READ(AUD_FLT2_COEF_A1A2_ADDR);
}

static inline void aud_ll_set_flt2_coef_a1a2_value(uint32_t value)
{
    REG_WRITE(AUD_FLT2_COEF_A1A2_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_A1A2_ADDR);
    reg_value = ((reg_value >> AUD_FLT2_COEF_A1A2_FLT2_A1_POS) & AUD_FLT2_COEF_A1A2_FLT2_A1_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt2_coef_a1a2_flt2_a1(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_A1A2_ADDR);
    reg_value &= ~(AUD_FLT2_COEF_A1A2_FLT2_A1_MASK << AUD_FLT2_COEF_A1A2_FLT2_A1_POS);
    reg_value |= ((value & AUD_FLT2_COEF_A1A2_FLT2_A1_MASK) << AUD_FLT2_COEF_A1A2_FLT2_A1_POS);
    REG_WRITE(AUD_FLT2_COEF_A1A2_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_flt2_coef_a1a2_flt2_a2(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_A1A2_ADDR);
    reg_value = ((reg_value >> AUD_FLT2_COEF_A1A2_FLT2_A2_POS) & AUD_FLT2_COEF_A1A2_FLT2_A2_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt2_coef_a1a2_flt2_a2(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_A1A2_ADDR);
    reg_value &= ~(AUD_FLT2_COEF_A1A2_FLT2_A2_MASK << AUD_FLT2_COEF_A1A2_FLT2_A2_POS);
    reg_value |= ((value & AUD_FLT2_COEF_A1A2_FLT2_A2_MASK) << AUD_FLT2_COEF_A1A2_FLT2_A2_POS);
    REG_WRITE(AUD_FLT2_COEF_A1A2_ADDR,reg_value);
}

/* REG_0x27 */
#define AUD_FLT2_COEF_B0B1_ADDR  (AUD_LL_REG_BASE  + 0x27*4) //REG ADDR :0x4780009c
...
{
    return REG_READ(AUD_FLT2_COEF_B0B1_ADDR);
}

static inline void aud_ll_set_flt2_coef_b0b1_value(uint32_t value)
{
    REG_WRITE(AUD_FLT2_COEF_B0B1_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_B0B1_ADDR);
    reg_value = ((reg_value >> AUD_FLT2_COEF_B0B1_FLT2_B0_POS) & AUD_FLT2_COEF_B0B1_FLT2_B0_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt2_coef_b0b1_flt2_b0(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_B0B1_ADDR);
    reg_value &= ~(AUD_FLT2_COEF_B0B1_FLT2_B0_MASK << AUD_FLT2_COEF_B0B1_FLT2_B0_POS);
    reg_value |= ((value & AUD_FLT2_COEF_B0B1_FLT2_B0_MASK) << AUD_FLT2_COEF_B0B1_FLT2_B0_POS);
    REG_WRITE(AUD_FLT2_COEF_B0B1_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_flt2_coef_b0b1_flt2_b1(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_B0B1_ADDR);
    reg_value = ((reg_value >> AUD_FLT2_COEF_B0B1_FLT2_B1_POS) & AUD_FLT2_COEF_B0B1_FLT2_B1_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt2_coef_b0b1_flt2_b1(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_B0B1_ADDR);
    reg_value &= ~(AUD_FLT2_COEF_B0B1_FLT2_B1_MASK << AUD_FLT2_COEF_B0B1_FLT2_B1_POS);
    reg_value |= ((value & AUD_FLT2_COEF_B0B1_FLT2_B1_MASK) << AUD_FLT2_COEF_B0B1_FLT2_B1_POS);
    REG_WRITE(AUD_FLT2_COEF_B0B1_ADDR,reg_value);
}

/* REG_0x28 */
#define AUD_FLT2_COEF_B2_ADDR  (AUD_LL_REG_BASE  + 0x28*4) //REG ADDR :0x478000a0
...
{
    return REG_READ(AUD_FLT2_COEF_B2_ADDR);
}

static inline void aud_ll_set_flt2_coef_b2_value(uint32_t value)
{
    REG_WRITE(AUD_FLT2_COEF_B2_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_B2_ADDR);
    reg_value = ((reg_value >> AUD_FLT2_COEF_B2_FLT2_B2_POS) & AUD_FLT2_COEF_B2_FLT2_B2_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt2_coef_b2_flt2_b2(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT2_COEF_B2_ADDR);
    reg_value &= ~(AUD_FLT2_COEF_B2_FLT2_B2_MASK << AUD_FLT2_COEF_B2_FLT2_B2_POS);
    reg_value |= ((value & AUD_FLT2_COEF_B2_FLT2_B2_MASK) << AUD_FLT2_COEF_B2_FLT2_B2_POS);
    REG_WRITE(AUD_FLT2_COEF_B2_ADDR,reg_value);
}

/* REG_0x29 */
#define AUD_FLT3_COEF_A1A2_ADDR  (AUD_LL_REG_BASE  + 0x29*4) //REG ADDR :0x478000a4
...
{
    return REG_READ(AUD_FLT3_COEF_A1A2_ADDR);
}

static inline void aud_ll_set_flt3_coef_a1a2_value(uint32_t value)
{
    REG_WRITE(AUD_FLT3_COEF_A1A2_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_A1A2_ADDR);
    reg_value = ((reg_value >> AUD_FLT3_COEF_A1A2_FLT3_A1_POS) & AUD_FLT3_COEF_A1A2_FLT3_A1_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt3_coef_a1a2_flt3_a1(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_A1A2_ADDR);
    reg_value &= ~(AUD_FLT3_COEF_A1A2_FLT3_A1_MASK << AUD_FLT3_COEF_A1A2_FLT3_A1_POS);
    reg_value |= ((value & AUD_FLT3_COEF_A1A2_FLT3_A1_MASK) << AUD_FLT3_COEF_A1A2_FLT3_A1_POS);
    REG_WRITE(AUD_FLT3_COEF_A1A2_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_flt3_coef_a1a2_flt3_a2(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_A1A2_ADDR);
    reg_value = ((reg_value >> AUD_FLT3_COEF_A1A2_FLT3_A2_POS) & AUD_FLT3_COEF_A1A2_FLT3_A2_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt3_coef_a1a2_flt3_a2(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_A1A2_ADDR);
    reg_value &= ~(AUD_FLT3_COEF_A1A2_FLT3_A2_MASK << AUD_FLT3_COEF_A1A2_FLT3_A2_POS);
    reg_value |= ((value & AUD_FLT3_COEF_A1A2_FLT3_A2_MASK) << AUD_FLT3_COEF_A1A2_FLT3_A2_POS);
    REG_WRITE(AUD_FLT3_COEF_A1A2_ADDR,reg_value);
}

/* REG_0x2A */
#define AUD_FLT3_COEF_B0B1_ADDR  (AUD_LL_REG_BASE  + 0x2A*4) //REG ADDR :0x478000a8
...
{
    return REG_READ(AUD_FLT3_COEF_B0B1_ADDR);
}

static inline void aud_ll_set_flt3_coef_b0b1_value(uint32_t value)
{
    REG_WRITE(AUD_FLT3_COEF_B0B1_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_B0B1_ADDR);
    reg_value = ((reg_value >> AUD_FLT3_COEF_B0B1_FLT3_B0_POS) & AUD_FLT3_COEF_B0B1_FLT3_B0_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt3_coef_b0b1_flt3_b0(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_B0B1_ADDR);
    reg_value &= ~(AUD_FLT3_COEF_B0B1_FLT3_B0_MASK << AUD_FLT3_COEF_B0B1_FLT3_B0_POS);
    reg_value |= ((value & AUD_FLT3_COEF_B0B1_FLT3_B0_MASK) << AUD_FLT3_COEF_B0B1_FLT3_B0_POS);
    REG_WRITE(AUD_FLT3_COEF_B0B1_ADDR,reg_value);
}
...
static inline uint32_t aud_ll_get_flt3_coef_b0b1_flt3_b1(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_B0B1_ADDR);
    reg_value = ((reg_value >> AUD_FLT3_COEF_B0B1_FLT3_B1_POS) & AUD_FLT3_COEF_B0B1_FLT3_B1_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt3_coef_b0b1_flt3_b1(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_B0B1_ADDR);
    reg_value &= ~(AUD_FLT3_COEF_B0B1_FLT3_B1_MASK << AUD_FLT3_COEF_B0B1_FLT3_B1_POS);
    reg_value |= ((value & AUD_FLT3_COEF_B0B1_FLT3_B1_MASK) << AUD_FLT3_COEF_B0B1_FLT3_B1_POS);
    REG_WRITE(AUD_FLT3_COEF_B0B1_ADDR,reg_value);
}

/* REG_0x2B */
#define AUD_FLT3_COEF_B2_ADDR  (AUD_LL_REG_BASE  + 0x2B*4) //REG ADDR :0x478000ac
...
{
    return REG_READ(AUD_FLT3_COEF_B2_ADDR);
}

static inline void aud_ll_set_flt3_coef_b2_value(uint32_t value)
{
    REG_WRITE(AUD_FLT3_COEF_B2_ADDR,value);
}
...
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_B2_ADDR);
    reg_value = ((reg_value >> AUD_FLT3_COEF_B2_FLT3_B2_POS) & AUD_FLT3_COEF_B2_FLT3_B2_MASK);
    return reg_value;
}
...
static inline void aud_ll_set_flt3_coef_b2_flt3_b2(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(AUD_FLT3_COEF_B2_ADDR);
    reg_value &= ~(AUD_FLT3_COEF_B2_FLT3_B2_MASK << AUD_FLT3_COEF_B2_FLT3_B2_POS);
    reg_value |= ((value & AUD_FLT3_COEF_B2_FLT3_B2_MASK) << AUD_FLT3_COEF_B2_FLT3_B2_POS);
    REG_WRITE(AUD_FLT3_COEF_B2_ADDR,reg_value);
}
